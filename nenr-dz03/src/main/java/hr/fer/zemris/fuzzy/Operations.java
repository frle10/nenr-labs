...
public class Operations {
	...
	public static final IUnaryFunction ZADEH_NOT = new IUnaryFunction() {
		@Override
	...
	public static final IBinaryFunction ZADEH_AND = new IBinaryFunction() {
		@Override
	...
	public static final IBinaryFunction ZADEH_OR = new IBinaryFunction() {
		@Override
		public double valueAt(double membership1, double membership2) {
